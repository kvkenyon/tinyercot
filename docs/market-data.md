...
and supply outlooks. The [scope guide](scope.md) distinguishes those inputs from
administrative reporting and planning illustrations. Older market observations
remain useful historical data.
